...
public class TestSetJunit5 {
  ...
  public void testBuy(){
    ...
    assertTrue(player.checkIfPlayerOwnsItem(item_0));
  ...
  public void testGetItemByName(){
    assertSame(item_0, player.getItemByName("test0"));
    assertEquals(item_0, player.getItemByName("test0"));
    assertNotEquals(item_1, player.getItemByName("test0"));
  }
